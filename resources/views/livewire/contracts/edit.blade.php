    ...
    <div class="card-body">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <select
                    class="form-select @error('counterparty_id') is-invalid @enderror"
        ...
        <livewire:contracts.addendums
            :contract="$contract"
            :key="'contract-addendums-'.$contract->id"
        />
        ...
        <div class="card border-primary mt-4">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between mb-2">
                    ...
                    <strong
                        class="{{ $contract->addendums_amount >= 0
                            ? 'text-success'
                            : 'text-danger'
                        }}"
                    >
