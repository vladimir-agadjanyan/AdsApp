...
class Edit extends Component
{
    ...
    public function mount(AdvertisingObject $advertisingObject): void
    {
        ...
        $this->counterpartyId =
            $advertisingObject->contract->counterparty_id;

        $this->contract_id =
            $advertisingObject->contract_id;

        $this->name =
            $advertisingObject->name;

        $this->advertising_type_id =
            $advertisingObject->advertising_type_id;

        $this->object_status_id =
            $advertisingObject->object_status_id;

        $this->regionId =
            $advertisingObject->city->region_id;

        $this->city_id =
            $advertisingObject->city_id;
    ...
    public function update(
        ...
        $advertisingObjectService->update(
            $this->advertisingObject,
            $validated
        );
        ...
        session()->flash(
            'success',
            'Рекламный объект успешно обновлен.'
        );
