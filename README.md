...
AdsApp — система контроля размещения наружной рекламы. Она позволяет компаниям, работающим с подрядчиками, вести договоры, контролировать рекламные объекты и получать фотоотчеты, подтверждающие выполнение работ по каждому объекту.
...
Создает договор
    ↓
Назначает контрагента
    ↓
Контрагент размещает рекламу
    ↓
Создает фотоотчет
    ↓
Ответственный сотрудник проверяет фото
    ↓
Работа подтверждена
